...
namespace Inmobiliaria.Api
{
    ...
    // GET: api/<Contratos>
    [HttpGet("inmueble/{id}")]
        public async Task<ActionResult<IEnumerable<Contrato>>> GetContratosPorInmuebles(int id)
        {
            ...
            try
            {
                ...
                var contratos = await contexto.Contratos
                    ...
                    if (contratos.FechaFin < DateTime.Now)
                    {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Contrato>> GetContratos(int id)
        {
